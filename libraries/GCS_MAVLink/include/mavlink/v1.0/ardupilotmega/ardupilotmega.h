...
enum MAV_CMD
{
	...
	MAV_CMD_DO_SET_GROUND_OPTIONS=206, /* Setup options for landing |enable abort on landing: 1 true, 0 false| target bearing of strip: [0-360], 0 is north| allowed abort angle (plus/minus): [0-180], 0 will always abort, 180 will never*/
